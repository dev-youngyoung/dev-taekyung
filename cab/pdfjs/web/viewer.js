...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '/cab/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/cab/pdfjs/web/cmaps/';
...
var PDFViewerApplication = {
  ...
  setTitleUsingUrl: function setTitleUsingUrl(url) {
    ...
    var title = PDFViewerApplication.fileName;
    if (!title) {
      try {
  ...
  download: function download() {
    ...
    var filename = PDFViewerApplication.fileName;
...
function fprint(){
	...
	if(isIE){
    	if(!document.getElementById("obj_pdf")){
	    	var obj = document.createElement('object');
	    	obj.id = "obj_pdf";
	    	obj.type="application/pdf";
	    	obj.data = PDFViewerApplication.appConfig.defaultUrl;
	    	obj.style.width="0px"
    	...
    	var doc = document.getElementById("obj_pdf");
        //Wait until PDF is ready to print    
        if (typeof doc.print === 'undefined') {    
            setTimeout(function(){fprint("obj_pdf");}, 1000);
        } else {
            doc.print();
        }
	}else{
	   	  if (!document.getElementById("print_iframe")) {
	   	   ...
	   	   iframe.src = PDFViewerApplication.appConfig.defaultUrl+"&attach_mode=off";  
	}
}
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: '/cab/pdfjs/web/debugger.js',
...
function webViewerLoad() {
  ...
  config.defaultUrl = pdf_url;
  PDFViewerApplication.fileName = down_file_name;
