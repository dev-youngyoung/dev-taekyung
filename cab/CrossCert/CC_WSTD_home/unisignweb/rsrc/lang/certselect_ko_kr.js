(function() {
	return {
		...
		IDS_CERT_LIST_SUMMARY: 								"이 리스트는 상태, 구분, 사용자, 발급자, 만료일로 구성되어 있는 인증서 리스트 입니다",
		IDS_CERT_TYPE: 										"타입",
		...
		IDS_SENSE_READER_INTRO:                             "인증서 선택(전자서명) 레이어가 열렸습니다. 매체를 선택하여 인증서 리스트를 확인하세요. 원할한 사용을 위해 스크린리더의 가상커서를 해제 해야 합니다.",
		
		IDS_SENSE_READER_BLANK_LINK:                        "이 버튼을 클릭하면 새창으로 링크가 열립니다.",
	    ...
	    IDS_MSGBOX_BLOCK_BIOTOKEN_FORISSUE:					"발급 및 갱신, 재발급시 지문보안토큰을 이용할 수 없습니다."   
	}
})();
