...
public class PDFMaker {
	...
	public boolean generatePDF(String html, String outputDir, String outputFileName) {
		...
		try{
			...
			//footer 데이터 셋팅
			if(footer == null){
				footerMark.setHtmlTemplate("<table width='100%' height='35px' border='0'><tr><td valign='bottom'><font size=1 color=\"#5B5B5B\">"+footerDefault+ " (관리번호:"+this.getContNo()+")</font></td></tr></table>");
			}else{
				footerMark.setHtmlTemplate("<span><font size=1 color=\"#5B5B5B\">"+ getFooter() +"</font></span>");
			}
			pd4ml.setPageFooter(footerMark);
