...
public class ContWLogDao extends DataObject {

	public ContWLogDao() {
		this.table = "tcw_cont_log";
	}

	public String makeLogSeq(String cont_no, String cont_chasu ){
		String log_seq = "";
		log_seq = this.getOne("select nvl(max(log_seq),0)+1 from tcw_cont_log where cont_no = '"+cont_no+"' and cont_chasu = '"+cont_chasu+"' ");
		return log_seq;
	}
