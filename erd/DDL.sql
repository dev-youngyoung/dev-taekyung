...
ALTER TABLE DOCU.TCB_MEMBER_PDS
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_MEMBER_PDS CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_MEMBER_PDS
(
  MEMBER_NO  CHAR(11 BYTE)                      NOT NULL,
  SEQ        NUMBER(10)                         NOT NULL,
...
ALTER TABLE DOCU.TCB_PERSON
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_PERSON CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_PERSON
(
  MEMBER_NO         CHAR(11 BYTE)               NOT NULL,
  PERSON_SEQ        NUMBER(10)                  NOT NULL,
...
ALTER TABLE DOCU.TCB_PERSON_AUTH
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_PERSON_AUTH CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_PERSON_AUTH
(
  MEMBER_NO    CHAR(11 BYTE)                    NOT NULL,
  PERSON_SEQ   NUMBER(10)                       NOT NULL,
  ADM_CD       CHAR(6 BYTE)                     NOT NULL,
...
CREATE UNIQUE INDEX DOCU.TCB_MEMBER_PDS_PK ON DOCU.TCB_MEMBER_PDS
(MEMBER_NO, SEQ)
LOGGING
TABLESPACE TS_DOCU_I
PCTFREE    10
...
CREATE UNIQUE INDEX DOCU.TCB_PERSON_AUTH_PK ON DOCU.TCB_PERSON_AUTH
...
CREATE UNIQUE INDEX DOCU.TCB_PERSON_PK ON DOCU.TCB_PERSON
...
DROP PUBLIC SYNONYM TCB_MEMBER_PDS;

CREATE PUBLIC SYNONYM TCB_MEMBER_PDS FOR DOCU.TCB_MEMBER_PDS;


DROP PUBLIC SYNONYM TCB_PERSON;

CREATE PUBLIC SYNONYM TCB_PERSON FOR DOCU.TCB_PERSON;


DROP PUBLIC SYNONYM TCB_PERSON_AUTH;

CREATE PUBLIC SYNONYM TCB_PERSON_AUTH FOR DOCU.TCB_PERSON_AUTH;


ALTER TABLE DOCU.TCB_MEMBER_PDS ADD (
  CONSTRAINT TCB_MEMBER_PDS_PK
  PRIMARY KEY
  (MEMBER_NO, SEQ)
  USING INDEX DOCU.TCB_MEMBER_PDS_PK);

ALTER TABLE DOCU.TCB_PERSON ADD (
  CONSTRAINT TCB_PERSON_PK
  PRIMARY KEY
  (MEMBER_NO, PERSON_SEQ)
  USING INDEX DOCU.TCB_PERSON_PK);

ALTER TABLE DOCU.TCB_PERSON_AUTH ADD (
  CONSTRAINT TCB_PERSON_AUTH_PK
  PRIMARY KEY
  (MEMBER_NO, PERSON_SEQ, ADM_CD)
  USING INDEX DOCU.TCB_PERSON_AUTH_PK);
...
GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_MEMBER_PDS TO DOCU_DML;

GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_PERSON TO DOCU_DML;

GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_PERSON_AUTH TO DOCU_DML;

GRANT SELECT ON DOCU.TCB_MEMBER_PDS TO DOCU_SEL;

GRANT SELECT ON DOCU.TCB_PERSON TO DOCU_SEL;

GRANT SELECT ON DOCU.TCB_PERSON_AUTH TO DOCU_SEL;
...
ALTER TABLE DOCU.TCB_EFILE_TEMPLATE
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_EFILE_TEMPLATE CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_EFILE_TEMPLATE
(
  TEMPLATE_CD  CHAR(7 BYTE)                     NOT NULL,
  MEMBER_NO    CHAR(11 BYTE)                    NOT NULL,
  EFILE_SEQ    NUMBER(10)                       NOT NULL,
...
ALTER TABLE DOCU.TCB_MEMBER_BOSS
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_MEMBER_BOSS CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_MEMBER_BOSS
(
  MEMBER_NO        CHAR(11 BYTE)                NOT NULL,
  SEQ              NUMBER                       NOT NULL,
  BOSS_NAME        VARCHAR2(30 BYTE),
...
ALTER TABLE DOCU.TCB_SRC_MEMBER
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_SRC_MEMBER CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_SRC_MEMBER
(
  MEMBER_NO      CHAR(11 BYTE)                  NOT NULL,
...
ALTER TABLE DOCU.TCB_STAMP
 DROP PRIMARY KEY CASCADE;

DROP TABLE DOCU.TCB_STAMP CASCADE CONSTRAINTS;

CREATE TABLE DOCU.TCB_STAMP
(
  CONT_NO      CHAR(11 BYTE)                    NOT NULL,
  CONT_CHASU   NUMBER(10)                       NOT NULL,
  MEMBER_NO    CHAR(11 BYTE)                    NOT NULL,
...
CREATE UNIQUE INDEX DOCU.PK_TCB_MEMBER_BOSS ON DOCU.TCB_MEMBER_BOSS
(MEMBER_NO, SEQ)
LOGGING
TABLESPACE TS_DOCU_I
PCTFREE    10
...
CREATE UNIQUE INDEX DOCU.TCB_EFILE_TEMPLATE_IDX ON DOCU.TCB_EFILE_TEMPLATE
...
CREATE UNIQUE INDEX DOCU.TCB_SRC_MEMBER_PK ON DOCU.TCB_SRC_MEMBER
...
CREATE UNIQUE INDEX DOCU.TCB_STAMP_IDX ON DOCU.TCB_STAMP
(CONT_NO, CONT_CHASU, MEMBER_NO)
LOGGING
TABLESPACE TS_DOCU_I
PCTFREE    10
...
DROP PUBLIC SYNONYM TCB_EFILE_TEMPLATE;

CREATE PUBLIC SYNONYM TCB_EFILE_TEMPLATE FOR DOCU.TCB_EFILE_TEMPLATE;


DROP PUBLIC SYNONYM TCB_MEMBER_BOSS;

CREATE PUBLIC SYNONYM TCB_MEMBER_BOSS FOR DOCU.TCB_MEMBER_BOSS;


DROP PUBLIC SYNONYM TCB_SRC_MEMBER;

CREATE PUBLIC SYNONYM TCB_SRC_MEMBER FOR DOCU.TCB_SRC_MEMBER;


DROP PUBLIC SYNONYM TCB_STAMP;

CREATE PUBLIC SYNONYM TCB_STAMP FOR DOCU.TCB_STAMP;


ALTER TABLE DOCU.TCB_EFILE_TEMPLATE ADD (
  CONSTRAINT TCB_EFILE_TEMPLATE_IDX
  PRIMARY KEY
  (TEMPLATE_CD, MEMBER_NO, EFILE_SEQ)
  USING INDEX DOCU.TCB_EFILE_TEMPLATE_IDX);

ALTER TABLE DOCU.TCB_MEMBER_BOSS ADD (
  CONSTRAINT PK_TCB_MEMBER_BOSS
  PRIMARY KEY
  (MEMBER_NO, SEQ)
  USING INDEX DOCU.PK_TCB_MEMBER_BOSS);

ALTER TABLE DOCU.TCB_SRC_MEMBER ADD (
  CONSTRAINT TCB_SRC_MEMBER_PK
  PRIMARY KEY
  (MEMBER_NO, SRC_CD, SRC_MEMBER_NO)
  USING INDEX DOCU.TCB_SRC_MEMBER_PK);

ALTER TABLE DOCU.TCB_STAMP ADD (
  CONSTRAINT TCB_STAMP_IDX
  PRIMARY KEY
  (CONT_NO, CONT_CHASU, MEMBER_NO)
  USING INDEX DOCU.TCB_STAMP_IDX);

ALTER TABLE DOCU.TCB_EFILE_TEMPLATE ADD (
  CONSTRAINT FK_TCB_EFILE_TEMPLATE_1 
  FOREIGN KEY (TEMPLATE_CD) 
  REFERENCES DOCU.TCB_CONT_TEMPLATE (TEMPLATE_CD));
...
GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_EFILE_TEMPLATE TO DOCU_DML;

GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_MEMBER_BOSS TO DOCU_DML;

GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_SRC_MEMBER TO DOCU_DML;

GRANT DELETE, INSERT, UPDATE ON DOCU.TCB_STAMP TO DOCU_DML;

GRANT SELECT ON DOCU.TCB_EFILE_TEMPLATE TO DOCU_SEL;

GRANT SELECT ON DOCU.TCB_MEMBER_BOSS TO DOCU_SEL;

GRANT SELECT ON DOCU.TCB_SRC_MEMBER TO DOCU_SEL;

GRANT SELECT ON DOCU.TCB_STAMP TO DOCU_SEL;
