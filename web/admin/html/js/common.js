...
{	
	...
	var vUrl	= "/FileDownLoad?"
						+ "FILE_KEY=" + argKey
						+ "&FILE_SUB_PATH=" + escape(argSubPath)
						+ "&FILE_TAR_FILE=" + escape(argTarFile_Name.replaceAll(",","_"));//jeus에서 unescape못하고 있음.
...
/*innerHTML 에서 사용자 입력 값을 못 가져오 기 때문에 선작업 합니다.*/
