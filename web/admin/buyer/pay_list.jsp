...
if(!f.get("s_member_no").equals(""))
{

	DataObject memberDao = new DataObject("tcb_member");
	DataSet member= memberDao.find(" member_no = '"+f.get("s_member_no")+"'  and (member_type='01' or member_type='03')", "member_no");
	if(member.next()){
		String sMemberNo = member.getString("member_no");
		
		DataObject fieldDao = new DataObject("tcb_field");
		DataSet field= fieldDao.find(" member_no = '"+sMemberNo+"'", "field_seq, field_name");
...
list.setTable("tcb_pay a, tcb_contmaster b, tcb_member c, tcb_member d ");
...
list.setOrderBy("a.accept_date desc, a.cont_no desc, a.cont_chasu desc");
...
p.setLayout("default");
//p.setDebug(out);
p.setBody("buyer.pay_list");
p.setVar("menu_cd","000049");
