...
DataSet ds = pDao.query("SELECT D.*, (SELECT USER_NAME FROM TCB_PERSON T WHERE D.REG_ID = T.USER_ID AND MEMBER_NO = '20201000001') AS USER_NAME " +
		   " FROM TCB_BOARD D" +
		   " WHERE BOARD_ID=" + id + " AND CATEGORY = 'noti'"
		);
if(!ds.next()){
...
f.addElement("reg_id", ds.getString("reg_id"), "hname:'등록자아이디'");
f.addElement("reg_name", ds.getString("user_name"), "hname:'등록자', required:'Y', maxbyte:'12'");
