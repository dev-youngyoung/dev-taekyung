...
if(u.isPost()&&f.validate()){
	...
	db.setCommand(cont2.getUpdateQuery("cont_no= '"+cont_no+"' and cont_chasu = '0'"), cont2.record);
	...
	u.jsAlertReplace("저장하였습니다.","contract_msign_modify_pop.jsp?"+u.getQueryString());
	return;
}
