...
// 사용자 계약번호 자동 설정 여부
boolean bAutoContUserNo = u.inArray(_member_no, new String[]{"20130500019","20121203661","20130400011","20130400010","20130400009","20130400008"});
...
if(u.isPost() ){
	...
	pdfInfo.addRow();
	pdfInfo.put("member_no",f.get("member_no"));
	...
	out.println("<script>");
	out.println("parent.document.forms['form1'].target='_self';");
	out.println("parent.document.getElementById('btn_sign').style.display = '';");
	out.println("</script>");
}
%>