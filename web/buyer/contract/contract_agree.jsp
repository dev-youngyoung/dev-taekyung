...
DataSet agree = agreeDao.find(where + " and r_agree_person_id is null and agree_cd = '1' and agree_person_id is not null");
if (agree.next()) {
	// 이메일 알림.
	...
	while (dsCust.next()) to_member_name = dsCust.getString("member_name");
...
u.jsAlertReplace("계약서를 담당자에게 검토요청 하였습니다.\\n\\n진행중인계약 목록에서 전송한 계약건을 확인 할 수 있습니다.", "contract_writing_list.jsp?" + u.getQueryString("cont_no, cont_chasu"));
%>