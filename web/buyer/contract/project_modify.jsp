...
if(!ds.next()){
	u.jsError("해당 프로젝트가 없습니다.");
	return;
}

f.addElement("order_name", ds.getString("order_name"), "hname:'발주자', required:'Y', maxbyte:'100'");
f.addElement("field_name", ds.getString("field_name"), "hname:'프로젝트명', required:'Y', maxbyte:'200'");
f.addElement("del_yn", ds.getString("del_yn"), "hname:'진행상태', required:'Y'");
...
if(u.isPost() && f.validate())
{
	...
	u.jsAlertReplace("저장 되었습니다.", "./project_modify.jsp?"+u.getQueryString());
	return;
}
