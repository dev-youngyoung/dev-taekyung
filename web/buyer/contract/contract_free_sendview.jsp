...
"tcb_contmaster.*"
+" ,(select user_name from tcb_person where user_id = tcb_contmaster.reg_id AND  MEMBER_NO = '20201000001') writer_name " // tcb_person 갑 불러오는 거로 수정필요
...
p.setLayout("default");
//p.setDebug(out);
p.setBody("contract.contract_free_sendview");
