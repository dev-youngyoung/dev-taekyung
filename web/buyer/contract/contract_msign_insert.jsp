...
//사용자 계약번호 자동 설정 여부
boolean bAutoContUserNo = u.inArray(_member_no, new String[]{
				"20121200073"	//로지스풀
...
if(u.isPost()&&f.validate()){
	...
	if(bAutoContUserNo){
		...
		// 로지스풀 자동계약번호
		if(_member_no.equals("20121200073")){
			...
			if("2019151".equals(template_cd)|| "2020068".equals(template_cd)){	//  만화 컨텐츠 제공 계약서(법인용)(template_cd : 2019240) <-> 만화 컨텐츠 제공 계약서(개인)(template_cd:2019151)  과 동일한 규칙
	...
	System.out.println(bAutoContUserNo);
	// 계약서파일 생성
