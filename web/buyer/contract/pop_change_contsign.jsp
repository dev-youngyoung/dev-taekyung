...
if(cust.next()){
	...
	int file_seq = 1;
		...
		if(!u.inArray(cont.getString("template_cd"), new String[] {"2017021","2017023","2017024","2017025","2017048"})){//한수테크니컬은 연봉계약서 전송 안함.
			...
			if(!cust.getString("hp2").equals("0000") && !cust.getString("hp1").equals("") && !cust.getString("hp2").equals("")){
				...
				if(member.getString("status").equals("02")){//비회원 전송일 경우
