...
String[] exp_stamp_path = {"20181002679=>20181002679/","20120200001=>20120200001/"};//경기테크노파크
...
// stamp_img = u.aseEnc(Startup.conf.getString("dir")+"/web/buyer/html/images/stamp/contract/"+u.getItem(cont.getString("status"), code_stamp_img));
...
if(cont.getString("template_cd").equals("")||!cfile.getString("auto_yn").equals("Y"))
{
	...
	if(bFooterShow){
		...
		String signStr = "<table width='740px' height='40px' border='0'><tr><td valign='bottom' style='font-family:나눔고딕; font-size:10px'><font color='#5B5B5B'>*본 계약서는 상기업체 간에 전자서명법  등 관련법령에 근거하여 전자서명으로 체결한 전자계약서입니다.<br>&nbsp;&nbsp;전자계약 진위여부는 나이스다큐(http://www.nicedocu.com,일반기업용)에서 확인하실 수 있습니다. (관리번호:"+sManageNo+")</font></td></tr></table>";
