...
//list.setDebug(out);
list.setListNum(10);
list.setTable("tcb_auth a");
list.setFields(
		 " a.* "
		+" ,(select user_name from tcb_person where member_no = a.member_no and user_id = a.mod_id) mod_name"
		+" ,(select count(*)  from tcb_person where member_no = a.member_no and auth_cd = a.auth_cd and status > 0 ) user_cnt"
		);
