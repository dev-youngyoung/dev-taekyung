...
if(u.isPost() && f.validate()){
	...
	DataSet enc = encDao.find(" b.asse_no = '"+asse_no+"' and b.div_cd = 'Q'" , "b.*");
	String encStatus = "";
	if(enc.next()){
	...
	if("90".equals(saveDiv)){
		...
		u.jsAlertReplace("평가완료 후 결과전송 하였습니다.","assessment_checking_elist.jsp?"+u.getQueryString());
		return;
	}

	u.jsAlertReplace(message, "assessment_checking_elist.jsp?"+u.getQueryString());
	return;
}

p.setLayout("default");
//p.setDebug(out);
p.setBody("cust.assessment_e_checkSheet_sumetime");
p.setVar("menu_cd","000104");
