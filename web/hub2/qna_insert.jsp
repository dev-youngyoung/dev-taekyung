...
if(u.isPost()&&f.validate()){
	...
	//나이스지라 로 메일보내기
	String body = "메인화면 시스템이용문의<br>회사명:"+f.get("companynm")+"<br>"+"문의자명:"+f.get("personnm")+"<br>"+"전화번호:"+f.get("hp1")+"-"+f.get("hp2")+"-"+f.get("hp3")+"<br>문의내용:"+u.nl2br(f.get("contents"));
	u.mail("nicedocu@nicednr.co.kr", "도입문의", body);

	out.println("<script>");
	out.println("alert('문의가 접수 되었습니다.\\n\\n내용확인 후 담당자 연락처로 문의내용 상담이 진행됩니다.');");
