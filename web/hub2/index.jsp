	...
	<div class="wrap">
		<header>
			<div class="inner-container">
				...
				<a href="./mobile_gnb.html" class="gnb-mobile"  onclick="ajaxLink(this.href,'GET','');return false;">메뉴열기</a>
			</div>
		</header>
		...
		<div class="container">
			...
			<%
				if(gubun.equals("buyer")){
			%>
<%@ include file="./content_buyer.jsp" %>
			<%
				}else if(gubun.equals("supplier")){
			%>
<%@ include file="./content_supplier.jsp" %>
			<%
				}else if(gubun.equals("fc")){
			%>
<%@ include file="./content_fc.jsp" %>
			<%
				}else if(gubun.equals("logis")){
			%>
<%@ include file="./content_logis.jsp" %>
			<%
				}else{
			%>
<%@ include file="./content_main.jsp" %>
			<%
				}
			%>
				...
				<div class="inner-container">
					...
					<ul class="contact-list">
						...
						<li>
							...
							<p>
								<a href="./qna.html" onclick="ajaxLink(this.href,'GET','');return false;">문의글 남기기</a>
							</p>
						</li>
					</ul>
				</div>
